...
\newcommand{\flate}{\ensuremath{f_{\textrm{SF}}}\xspace}
...
%\newcommand{\logM}{\ensuremath{\log\,( \mathcal{M}_* / \mathcal{M}_{\odot} )}}
\newcommand{\logM}{\ensuremath{\log\,(\mstar/\msun)}\xspace}
...
\newcommand{\citePB}{BE16\xspace}
\newcommand{\hubble}{\ensuremath{70~\textrm{km~s}^{-1}~\textrm{Mpc}^{-1}}}

\newcommand{\np}{\ensuremath{n_{\textrm p}}\xspace}
\newcommand{\nall}{\ensuremath{n_{\textrm{all}}}\xspace}
\newcommand{\fP}{\ensuremath{\mathcal{F}_{\textrm P}}\xspace}
\newcommand{\fSF}{\ensuremath{\mathcal{F}_{\textrm{SF}}}\xspace}
